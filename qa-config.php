...
if (!isset($_ENV["DB_HOST"]) || !isset($_ENV["DB_HOST"]) || !isset($_ENV["DB_HOST"]) || !isset($_ENV["DB_HOST"])){
  //Dbs settings missing
  die("DB config is missing");
}

	define('QA_MYSQL_HOSTNAME', $_ENV["DB_HOST"]);
	define('QA_MYSQL_USERNAME', $_ENV["DB_USER"]);
	define('QA_MYSQL_PASSWORD', $_ENV["DB_PASSWORD"]);
	define('QA_MYSQL_DATABASE', $_ENV["DB_NAME"]);
